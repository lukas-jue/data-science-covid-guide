...
\item
  \href{https://www.datacamp.com/courses/optimizing-python-code-with-pandas}{Optimize Python Code with pandas}
\item
  \href{https://www.datacamp.com/courses/deep-learning-in-python}{Deep Learning in Python (4h)}
\item
