...
\item
  \href{https://www.datacamp.com/courses/importing-data-in-r-part-1}{Importing Data in R (3h)}: utils, readr, data.table, XLConnect
\item
...
\item
  \href{https://www.datacamp.com/courses/machine-learning-toolbox}{Machine Learning Toolbox (4h)}: train()-function, cross-validation, auc
\end{itemize}
...
\tightlist
\item
  \href{https://www.datacamp.com/courses/intermediate-python-for-data-science}{Intermediate Python for Data Science (4h)}: Matplotlib, Dict, Pandas, Loops
\item
...
\item
  \href{https://www.datacamp.com/courses/importing-data-in-python-part-1}{Importing Data in Python (Part 1) (4h)}: Import.csv, .txt, SQL
\item
  \href{https://www.datacamp.com/courses/importing-data-in-python-part-2}{Importing Data in Python (Part 2) (2h)}: Interactin with APIs
\item
...
\item
  \href{https://www.datacamp.com/courses/unsupervised-learning-in-python}{Unsupervised Learning in Python (4h)}: Clustering, t-SNE, Decorrelation
\item
...
\item
  \href{https://www.datacamp.com/courses/deep-learning-in-python}{Deep Learning in Python (4h)}: Neural Networks, Backpropagation, Keras
\end{itemize}
...
\tightlist
\item
  \href{https://www.datacamp.com/projects/684}{Project: TV, Halftime Shows and the Big Game}
\item
  \href{https://www.datacamp.com/courses/interactive-data-visualization-with-bokeh}{Interactive Data Visualization with Bokeh}
\item
  \href{https://www.datacamp.com/courses/introduction-to-time-series-analysis-in-python}{Introduction to Time Series Analysis}
\item
  \href{https://www.datacamp.com/courses/machine-learning-for-time-series-data-in-python}{Machine Learning for Time Series Data}
\item
  \href{https://www.datacamp.com/courses/advanced-deep-learning-with-keras-in-python}{Advanced Deep Learning with Keras}
\item
  \href{https://www.datacamp.com/courses/data-visualization-with-seaborn}{Data Visualization with Seaborn}
\item
  \href{https://www.datacamp.com/courses/web-scraping-with-python}{Web Scraping in Python}
\item
  \href{https://www.datacamp.com/courses/writing-efficient-python-code}{Writing Efficient Python Code}
\item
  \href{https://www.datacamp.com/courses/optimizing-python-code-with-pandas}{Optimize Pzthon Code with pandas}
\item
  \href{https://www.datacamp.com/courses/forecasting-using-arima-models-in-python}{Forecasting using ARIMA Models}
\end{itemize}
